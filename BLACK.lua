...
if Json_Info.result.can_chablacke_info == true then
info = 'ꪜ'
else
info = '✘'
end
...
tdcli_function ({ ID = "SendChatAction",chat_id_ = id_user, action_ = {  ID = "SendMessageTypiblackAction", progress_ = 100} },function(arg,ta) 
...
chat_id_ = pv[i], action_ = {  ID = "SendMessageTypiblackAction", progress_ = 100} 
},function(arg,data) 
...
tdcli_function ({ID = "ChablackeChatMemberStatus",chat_id_=group[i],user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
w = w + 1
end
...
if database:get(bot_id..'Chablacke:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) then 
if msg.content_.photo_.sizes_[3] then  
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_ 
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_ 
end 
tdcli_function ({ID = "ChablackeChatPhoto",chat_id_ = msg.chat_id_,photo_ = getInputFile(photo_id) }, function(arg,data)   
if data.code_ == 3 then
send(msg.chat_id_, msg.id_,' عذرا البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا') 
database:del(bot_id..'Chablacke:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_) 
return false  end
...
send(msg.chat_id_,0,"• عضو : {["..data.first_name_.."](T.ME/BLACK_TEAM_4)}\n•["..MODEDEV_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
--------------------------------------------------------------------------------------------------------------
if not Special(msg) and msg.content_.ID ~= "MessageChatAddMembers" and database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"flood") then 
floods = database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"flood") or 'nil'
NUM_MSG_MAX = database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodmax") or 5
TIME_CHECK = database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodtime") or 5
local post_count = tonumber(database:get(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
if post_count > tonumber(database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodmax") or 5) then 
local ch = msg.chat_id_
local type = database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"flood") 
trigger_anti_spam(msg,type)  
end
database:setex(bot_id..'floodc:'..msg.sender_user_id_..':'..msg.chat_id_, tonumber(database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodtime") or 3), post_count+1) 
local edit_id = data.text_ or 'nil'  
NUM_MSG_MAX = 5
if database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodmax") then
NUM_MSG_MAX = database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodmax") 
end
if database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodtime") then
TIME_CHECK = database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodtime") 
end 
end 
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_,0, "•عذرا يا > {["..data.first_name_.."](T.ME/BLACK_TEAM_4)}\n• الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendAudio(msg.chat_id_,msg.id_,'./'..msg.sender_user_id_..'.mp3','@BLACK_TEAM_4','•غنيلي = اغاني عشوائيه اهداء من البوت•','end')
...
local MODEDEVCheblackName = database:get(bot_id.."MODEDEV:Cheblack:Name"..data.id_)
if not data.first_name_ then 
if MODEDEVCheblackName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MODEDEVCheblackName..']')
database:del(bot_id.."MODEDEV:Cheblack:Name"..data.id_) 
end
end
if data.first_name_ then 
if MODEDEVCheblackName ~= data.first_name_ then 
local Text = {
  "جان اسمك خوش اسم ",
"ليش غيرت اسمك يحلو ",
"هذا لحلو غير اسمه ",
...
if data.id_ then 
if data.id_ ~= bot_id then
local MODEDEVCheblackUserName = database:get(bot_id.."MODEDEV:Cheblack:UserName"..data.id_)
if not data.username_ then 
if MODEDEVCheblackUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MODEDEVCheblackUserName..']')
database:del(bot_id.."MODEDEV:Cheblack:UserName"..data.id_) 
end
end
if data.username_ then 
if MODEDEVCheblackUserName ~= data.username_ then 
local Text = {
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MODEDEVCheblackPhoto = database:get(bot_id.."MODEDEV:Cheblack:Photo"..data.id_)
if not data.profile_photo_ then 
if MODEDEVCheblackPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صوره الحلو 😂👌🏻")
database:del(bot_id.."MODEDEV:Cheblack:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MODEDEVCheblackPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
Text = [[
╭• [𝑺𝑶𝑼𝑹𝑺𝑬 BLACK](t.me/BLACK_TEAM_4) •╮
]]
send(msg.chat_id_, msg.id_,Text)
return false
end
...
if text == '@eljo_ker_m' or text == '@BLACK_TEAM_4' or text == 'جوكر' then
Text = [[
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'*• الرتبه >* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'BLACK_TEAM_4')..')\n*• الاسم >* ['..utf8.sub(data.first_name_,0,15)..'](T.ME/'..(data.username_ or 'BLACK_TEAM_4')..') \n*•تم قفـل الدردشه*\n')  
end,nil)   
...
tdcli_function ({ ID = "ChablackeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
...
tdcli_function ({ ID = "ChablackeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChablackeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusKicked" },},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChablackeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
end
...
tdcli_function ({ ID = "ChablackeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = result.id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'BLACK_TEAM_4')..')'
status  = '\n تم الغاء حظره من هنا'
texts = usertext..status
else
...
tdcli_function ({ ID = "ChablackeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = userid, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'BLACK_TEAM_4')..') ~'
status  = '\n تم الغاء حظره من هنا'
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chablacke_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chablacke_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chablacke_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chablacke_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_chablacke_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
return false
...
texts = usertext..status
send(msg.chat_id_, msg.id_, texts)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.id_.."&can_chablacke_info=True&can_delete_messages=True&can_invite_users=True&can_restrict_members=True&can_pin_messages=True&can_promote_members=True")
else
send(msg.chat_id_, msg.id_, '• لا يوجد حساب بهاذا المعرف')
end
end
...
if database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_, "flood") == "kick" then     
flood = 'بالطرد •'     
elseif database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"flood") == "keed" then     
flood = 'بالتقيد •'     
elseif database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"flood") == "mute" then     
flood = 'بالكتم •'           
elseif database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"flood") == "del" then     
flood = 'بالمسح •'           
else     
flood = '✘'     
end
...
NUM_MSG_MAX = database:hget(bot_id.."floodiblack:settiblacks:"..msg.chat_id_,"floodmax") or 0
local text = 
...
database:hset(bot_id.."floodiblack:settiblacks:"..msg.chat_id_ ,"floodmax" ,Num) 
...
database:hset(bot_id.."floodiblack:settiblacks:"..msg.chat_id_ ,"floodtime" ,Num) 
...
database:set(bot_id..'Chablacke:Chat:Photo'..msg.chat_id_..':'..msg.sender_user_id_,true) 
...
database:del(bot_id.."CHEblack:ID"..msg.chat_id_..""..msg.sender_user_id_) 
local CHEblackER_ID = text:match("(.*)")  
database:set(bot_id.."KLISH:ID"..msg.chat_id_,CHEblackER_ID)
...
tdcli_function ({ ID = "ChablackeChatTitle",chat_id_ = msg.chat_id_,title_ = Name },function(arg,data) 
if data.message_ == "Channel chat title can be chablacked by administrators only" then
send(msg.chat_id_,msg.id_,"• البوت ليس ادمن يرجى ترقيتي !")  
return false  
end 
if data.message_ == "CHAT_ADMIN_REQUIRED" then
...
tdcli_function ({ID = "ChablackeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
...
tdcli_function({ID="ChablackeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=msg.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,data) 
if (data and data.code_ and data.code_ == 400 and data.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_, msg.id_,'• ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !') 
return false  
end
...
tdcli_function ({ ID = "ChablackeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
...
Text = ' • عدد جهاتك > ['..Num..'](https://t.me/BLACK_TEAM_4) •'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
name = Hussein[math.random(#Hussein)]
database:del(bot_id..'Set:Eblacklish:Bot'..msg.chat_id_)
database:set(bot_id..':Set:Eblacklish'..msg.chat_id_,name)
...
------------------------------------------------------------------------
if text == ''..(database:get(bot_id..':Set:Eblacklish'..msg.chat_id_) or '')..'' then 
if not database:get(bot_id..'Set:Eblacklish:Bot'..msg.chat_id_) then 
database:del(bot_id..':Set:Eblacklish'..msg.chat_id_)
send(msg.chat_id_, msg.id_,'•┇ الف مبروك لقد فزت \n•┇ للعب مره اخره ارسل ←{ `انكليزي` }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
database:set(bot_id..'Set:Eblacklish:Bot'..msg.chat_id_,true)
end
------------------------------------------------------------------------
if text == 'امثله' then
if AddChannel(msg.sender_user_id_) == false then
...
لعبة رياضيات >> رياضيات
 ...
 لعبة بات >> بات
•━━━━━━• 
- Ch [ᥰᎥᧁᧁꪖ - SoUrCe](https://t.me/BLACK_TEAM_4)
]]
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = getChatId(msg.chat_id_).ID,filter_ = {ID = "ChannelMembersBots"},offset_ = 0,limit_ = 100 },function(arg,tah) local admins = tah.members_ for i=0 , #admins do if tah.members_[i].status_.ID ~= "ChatMemberStatusEditor" and not is_mod(msg) then tdcli_function ({ID = "ChablackeChatMemberStatus",chat_id_ = msg.chat_id_,user_id_ = admins[i].user_id_,status_ = {ID = "ChatMemberStatusKicked"},}, function(arg,f) end, nil) end end end,nil)  
end
end     
end
end
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatDeletePhoto" or msg.content_.ID == "MessageChatChablackePhoto" or msg.content_.ID == 'MessagePinMessage' or msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" or msg.content_.ID == 'MessageChatChablackeTitle' or msg.content_.ID == "MessageChatDeleteMember" then   
if database:get(bot_id..'lock:tagservr'..msg.chat_id_) then  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false
end    
...
tdcli_function ({ID = "ChablackeChatMemberStatus",chat_id_=v,user_id_=bot_id,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
database:srem(bot_id..'Chek:Groups',v)  
end
